      ...
      >
        ...
        <div className="permModal-body">
          ...
          <section className="permModal-section">
            <h3 className="permModal-section-title">Rol asignado</h3>
            <div className="permModal-roleBox">{usuario.role}</div>
          </section>
        ...
        <footer className="permModal-footer">
          ...
          <button className="permModal-btn save" onClick={handleSave}>
            Guardar permisos
          </button>
        </footer>
      </div>
