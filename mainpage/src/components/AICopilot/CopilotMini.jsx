...
export default function CopilotMini({ messages, loading, toolStatus, insights, insightsLoading, onSend, onRetry, onFeedback, onClose, onFullscreen, onSuggestionClick }) {
  return (
    <div className="copilot-mini">
      ...
      <CopilotMessages messages={messages} loading={loading} toolStatus={toolStatus} insights={insights} insightsLoading={insightsLoading} onSuggestionClick={onSuggestionClick} onRetry={onRetry} onFeedback={onFeedback} />
